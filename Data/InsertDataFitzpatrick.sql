...
exec procScheduleGame
    ...
    @GameDateTime = '2026-01-25 15:00:00',
    @GameStartTime = '2026-01-25 15:00:00',
...
--trigger to track changes made by NFLADMIN to the Game table for score updates
--1 triggering event update on game table where HomeTeamScore or AwayTeamScore is updated
--2 action insert a record into adminchangestracker with NFLAdminID, GameID, ChangeType='Update', ChangeDescription with the updated scores and winning team
